...
# hewlettpackard.com/squest-operator-bundle:$VERSION and hewlettpackard.com/squest-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= hewlettpackard.com/squest-operator
